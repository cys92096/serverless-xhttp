...
// 环境变量
const UUID = process.env.UUID || '686f1ee8-7748-40d1-8d41-cad4dcc094cd'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'lixian1-xh.hf.space';                   // 域名或ip,留空将自动获取服务器ip
